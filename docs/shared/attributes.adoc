...
//***NEW START***
:UpstreamProductName: FeedHenry
:WFMNameLong: Workflow Management
:WFMNameShort: WFM
:RCNameLong: RainCatcher
//***NEW END***
...
//***NEW***RHMAP docs
:MyTitleABookName: Workflow Management Framework

//***NEW***Upstream-1 docs
:MyTitleUpstreamBookName: RainCatcher Framework
